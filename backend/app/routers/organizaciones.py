...
from app.schemas import OrganizacionRespuesta, OrganizacionEditarPerfil, OrganizacionCambiarPassword
...
@router.put(
    ...
    summary="Editar nombre y correo"
)
def editar_perfil(
    ...
    if datos.correo is not None:
        ...
        correo_en_uso = db.query(models.Organizacion).filter(
