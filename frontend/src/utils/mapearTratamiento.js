...
export function mapearTratamientoAForm(data) {
  ...
  return {
    ...
    origen_datos_detalle: ext.origen_datos_detalle || "",
    ...
    metodo_eliminacion_otro: ext.metodo_eliminacion_otro || "",
    ...
    evaluacion_periodica_detalle: ext.evaluacion_periodica_detalle || "",
