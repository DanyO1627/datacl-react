...
/* ─── Opciones de fuente ─────────────────────────────────────── */
const OPCIONES = [
  { id: "archivo",  titulo: "Subir archivo",         desc: "CSV o Excel (.xlsx, .xls)", icono: <IconoArchivo /> },
  { id: "bd",       titulo: "Conectar a BD",          desc: "MySQL, PostgreSQL…",         icono: <IconoBD /> },
  { id: "manual",   titulo: "Ingresar manualmente",   desc: "Sin archivo",                icono: <IconoManual /> },
  { id: "sesiones", titulo: "Sesiones anteriores",    desc: "Reutilizar análisis previo", icono: <IconoHistorial /> },
];
...
export default function NuevaSesion() {
  ...
  function handleReutilizar(sesion) {
    navigate("/resultados-analisis", {
      state: {
        detectados: sesion.campos_detectados || [],
        pendientes: sesion.campos_pendientes  || [],
      },
    });
  }
